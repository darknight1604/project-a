...
import 'features/user_list/domains/models/user_response.dart';
import 'features/user_list/infrastructures/services/user_service_impl.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BlocProvider(
        create: (context) =>
            UserListBloc(UserServiceImpl())..add(FetchUserListEvent()),
